...
type NetworkSpec struct {
	...
	// +kubebuilder:validation:XValidation:message="network provider must be disabled (reverted to empty string) before a new provider is enabled",rule="oldSelf == '' || self == oldSelf"
	// +nullable
	// +optional
